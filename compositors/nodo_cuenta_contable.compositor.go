...
func (c *NodoCuentaContableCompositor) BuildTree() (rootNodes []*models.NodoArbolCuentaContable, err error) {
	rootNodes, _, err = c.nodoCcManager.GetRootNodes()

	if err != nil {
		return
	}
	_, noRootNodes, err := c.nodoCcManager.GetNoRootNodes()
	if err != nil {
		return
	}
